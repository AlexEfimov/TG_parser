"""Initial raw storage schema

Revision ID: 0001_raw
Revises: 
Create Date: 2025-12-29

Creates initial schema for raw_storage.sqlite:
- raw_messages table (TR-18, TR-20)
- raw_conflicts table (TR-8)
"""
