"""Initial processing storage schema

Revision ID: 0001_processing
Revises: 
Create Date: 2025-12-29

Creates initial schema for processing_storage.sqlite:
- processed_documents table (TR-22, TR-43)
- processing_failures table (TR-47)
- topic_cards table (TR-43)
- topic_bundles table (TR-43)
- api_jobs table (Phase 2F)
- agent_states table (Phase 3B)
- task_history table (Phase 3B)
- agent_stats table (Phase 3B)
- handoff_history table (Phase 3B)
"""
...
def upgrade() -> None:
    ...
    # Partial unique index for current bundles
    op.execute("""
    ...
    # Unique index for snapshot bundles
    op.execute("""
