...
class SQLiteRawMessageRepo(RawMessageRepo):
    ...
    async def upsert(self, message: RawTelegramMessage) -> bool:
        ...
        raw_payload_json, truncated, original_size = self._serialize_payload(
            message.raw_payload
        )
    ...
    def _serialize_payload(self, payload: Optional[dict]) -> tuple[Optional[str], bool, Optional[int]]:
        """
