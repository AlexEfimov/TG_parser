...
**Сессия R7 переписана** — из диагностической в короткую сессию подтверждения и выбора формы фикса (четыре варианта, рекомендация — доставка инстант-матчей из бот-процесса по уже работающей batch-машинерии). Стартовый промпт: [`START_PROMPT_FIX_BUG095_WATCHLIST_DELIVERY_R7_2026-08-13.md`](docs/notes/START_PROMPT_FIX_BUG095_WATCHLIST_DELIVERY_R7_2026-08-13.md).
