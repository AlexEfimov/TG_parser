...
> ⚠️ **ARCHIVED** — этот документ отражает состояние на v3.1.1 (декабрь 2025). Актуальная версия проекта — **v4.2** (апрель 2026). Используйте [README.md](/README.md) и [ROADMAP_V3](/docs/notes/ROADMAP_V3_PRODUCTION_FIRST.md) как актуальные точки входа.
