...
**Session #3:**
- Plan: [`PLAN_SESSION_CODE_REVIEW_BOT_MCP_3_2026-08-12.md`](PLAN_SESSION_CODE_REVIEW_BOT_MCP_3_2026-08-12.md)
- START: [`START_PROMPT_SESSION_CODE_REVIEW_BOT_MCP_3_2026-08-12.md`](START_PROMPT_SESSION_CODE_REVIEW_BOT_MCP_3_2026-08-12.md)
...
3. GO на опасные прогоны в #1: `trigger_*`, `force_resummarize`, `backfill_watchlist`, subscribe на реальный chat_id, `set_llm_config` / `reset_llm_config`, live Telegram bot smoke.
