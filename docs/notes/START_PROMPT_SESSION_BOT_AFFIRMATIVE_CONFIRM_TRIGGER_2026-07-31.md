...
> ## ✅ LANDED (2026-07-31) — план исполнен целиком, реализация в дереве
>
...
>
> **Не сделано намеренно:** ADR-0020 остаётся `Proposed` (перевод в `Accepted` — после мержа, по его же §Статус); issue #359 не редактировался; `git commit` не выполнялся.
