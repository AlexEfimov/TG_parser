...
> **Отработал 2026-08-16.** Протокол — [`BUG102_R3_DEPLOY.md`](../../runbooks/BUG102_R3_DEPLOY.md).
> Переехал в `archive/` тем же PR по правилу [`AUDIT_DOCUMENTATION_2026-08-12.md`](../AUDIT_DOCUMENTATION_2026-08-12.md) §4.
> Относительные ссылки ниже поправлены под `docs/notes/archive/`. Пути в блоке Opener (backtick) — исторические, от корня репозитория на момент прогона.
