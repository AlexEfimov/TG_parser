...
2. ~~Оговорка к `download_url` в `MCP_AGENT_GUIDE:375–377` и `:948` — до фикса BUG-096.~~ **Снято фиксом R4** (2026-08-15, merge `#426` → `75c8c07`, прод-smoke GET → 200). Гайд оставляет утверждение о download как есть.
