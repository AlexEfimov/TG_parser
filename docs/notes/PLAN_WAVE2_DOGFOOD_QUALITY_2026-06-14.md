...
> **Текущее forward-состояние / что shipped после Wave 2** — см. [`ROADMAP` § «Post-Wave-2 треки»](ROADMAP_KARPATHY_LIKE_LIVING_KB.md) (актуальный SoT). [`DRAFT_NEXT_CONTRACT_POST_WAVE2_2026-06-18.md`](DRAFT_NEXT_CONTRACT_POST_WAVE2_2026-06-18.md) — исторический decision-brief (все треки уже разрешены). Июльские handoff'ы: remediation S0–S7, F9 Phase 2–3, Phase-1 watch t2 FINAL, BUG-085 B1/B2. Историю ниже **не переоткрывать как implementation-sprint** — она сохранена как decision-log.
>
