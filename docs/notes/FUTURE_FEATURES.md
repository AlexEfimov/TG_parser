...
|---------|---------|--------|-------------|
| 1.1 | **F9 Phase 1**: Security Quick Fixes | ~0.5 сессии | Critical уязвимости: открытые API, MCP без auth |
| 1.2 | **F8-A**: Hardening | ~1 сессия | Unified retry, DB pool fix, metrics wiring |

**Итого Волна 1: ~1.5 сессии**
...
| 3.3 | **F1**: Configurable Prompts | ~2 сессии | Тонкая настройка качества |
...
| Волны 1–2 (фундамент + core) | ~5.5 сессий |
| Волны 1–3 (до engagement) | ~12–13 сессий |
| Волны 1–4 (до monetization) | ~23–25 сессий |
...
### Решение: DB primary + YAML fallback/seed
...
#### Phase 1: Quick Fixes (~0.5 сессии)
