...
**Что по-прежнему НЕ закрыто:** ревью изменений конфигурации. Бэкап отвечает на «как восстановить», но не на «кто и зачем поменял». Это закрывается только выбором варианта из таблицы выше.
